...
const guideSlug = computed(() => route.params.slug as string)
...
function goToSettings() {
  if (guide.value) { router.push(`/settings#${guide.value.settingsSection}`) }
}
...
<template>
  <div class="view-page">
    <div class="view-inner" style="max-width: 960px">
      <Button text severity="secondary" icon="pi pi-arrow-left" label="Back" class="mb-4" @click="router.back()" />

      <Message v-if="!guide" severity="warn" class="mb-4">Guide not found. Check the URL and try again.</Message>
